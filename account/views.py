...
def send_activation_mail(user):
    ...
    send_mail('Activation Account', f'Youre Successfully Registered. Please Activate Your Account by Following This Link http://127.0.0.1:8000/account/activate/{code}/', 'admin@gmail.com', [user.email, ])
